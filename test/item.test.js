...
describe('TESTING ITEM', function() {
  before(async function() {
    await itemModel.deleteMany({ name: 'item name' })
      ...
      chai
        ...
        .then(function(res) {
          ...
          expect(res.body)
            ...
            .equal(res.body.price)
          expect(res.body)
            .to.have.property('quantity')
            .equal(res.body.quantity)
          expect(res.body)
            .to.have.property('image')
            .equal(res.body.image)
          expect(res.body)
            .to.have.property('ownerId')
            .equal(res.body.ownerId)
          expect(res.body)
            .to.have.property('status')
            .equal(res.body.status)
          expect(res.body)
            .to.have.property('location')
            .equal(res.body.location)
          itemTravel = res
          done()
        })
        .catch(done)
      ...
      it('should return status 400 when object image is empty', function(done) {
        chai
          ...
          .then(function(res) {
            ...
            expect(res.body)
              .to.have.property('image')
              .equal('https://via.placeholder.com/150')
            expect(res.body)
              .to.have.property('ownerId')
              .equal(res.body.ownerId)
            expect(res.body)
        ...
        chai
          ...
          .then(function(res) {
            ...
            expect(res.body.errors[0]).to.equal(
              'you must enter with travel or watch',
            )
            done()
          })
          .catch(done)
      ...
      chai
        ...
        .then(function(res) {
          ...
          expect(res.body)
            ...
            .to.be.a('number')
          expect(res.body)
            .have.property('quantity')
            .to.be.a('number')
          expect(res.body)
            .have.property('image')
            .to.be.a('string')
          expect(res.body)
            .have.property('ownerId')
            .to.be.a('object')
          expect(res.body)
